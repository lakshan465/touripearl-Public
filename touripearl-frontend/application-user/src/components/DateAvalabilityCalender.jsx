...
const DateRangeAvailabilityCalendar = ({guideId}) => {
  ...
  return (
      <div className="p-6 max-w-md mx-auto bg-white rounded-xl shadow-lg transition-shadow duration-300 hover:shadow-xl">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl font-bold text-indigo-700">Availability Calendar</h2>
        </div>
...
export default DateRangeAvailabilityCalendar;